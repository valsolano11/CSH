...
export default function SoftwarePage() {
  ...
  const createWhatsAppUrl = () => {
    ...
    return `https://wa.me/573025305818?text=${encodeURIComponent(message)}`
  }
    ...
    <main className="software-page">
      <section className="software-hero">
        <div className="software-hero-grid">
          <div className="software-hero-content">
            <div className="software-kicker"><span />CATÁLOGO DE SOFTWARE</div>
            ...
            <p>Explora nuestras soluciones de software y encuentra la modalidad de licenciamiento adecuada para tu empresa, tus equipos y tus necesidades.</p>

            <div className="software-hero-actions">
              <a href="#catalogo" className="software-primary-button">Explorar soluciones <ChevronRight size={17} /></a>
              <a href={WHATSAPP_BASE} target="_blank" rel="noopener noreferrer" className="software-secondary-link">Necesito asesoría <ArrowUpRight size={16} /></a>
            </div>
          </div>
          ...
          <div className="software-hero-visual">
            ...
            <div className="hero-main-card">
              ...
              <div className="hero-card-icon"><FileKey size={48} strokeWidth={1.3} /></div>

              <span className="hero-card-label">SOLUCIONES DIGITALES</span>
      ...
      <section id="catalogo" className="software-catalog">
        <div className="catalog-top">
          ...
          <p>Conoce nuestras marcas y modalidades de licenciamiento. Selecciona una solución para consultar toda la información disponible.</p>
        </div>

        <div className="catalog-toolbar">
          <div className="catalog-search-wrapper">
            <div className="catalog-search">
              <div className="catalog-search-icon"><Search size={18} /></div>

              <div className="catalog-search-input">
                <span>Buscar solución</span>
                <input type="text" placeholder="Microsoft, Kaspersky, Sophos..." value={search} onChange={(event) => setSearch(event.target.value)} aria-label="Buscar software" />
              </div>

              {search && (
                <button type="button" className="catalog-search-clear" onClick={() => setSearch('')} aria-label="Limpiar búsqueda"><X size={16} /></button>
              )}
          ...
          <div className="product-results">
            {filteredProducts.map((product, index) => (
              <article key={product.id} className="product-card" onClick={() => setSelectedProduct(product)}>
                ...
                <div className="product-card-footer">
                  ...
                  <div className="product-card-arrow"><ArrowUpRight size={16} /></div>
                </div>
              </article>
            ))}
            ...
            {filteredProducts.length === 0 && (
              <div className="empty-search">
                <div className="empty-search-icon"><Search size={25} /></div>
                <h3>No encontramos esa solución</h3>
                <p>Prueba buscando por marca, categoría o modalidad de licenciamiento.</p>
                <button type="button" onClick={() => { setSearch(''); setCategory('Todos') }}>Ver todas las soluciones</button>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="software-advice">
        <div className="advice-inner">
          <div className="advice-icon"><Cloud size={28} /></div>
          ...
          <div className="advice-text">
            <p>Cuéntanos qué necesitas, qué equipos utilizas y cómo trabaja tu empresa. Te ayudamos a identificar la solución y modalidad que mejor se adapte a tu caso.</p>
            <a href={WHATSAPP_BASE} target="_blank" rel="noopener noreferrer" className="advice-button">Hablar con un asesor <ArrowUpRight size={17} /></a>
          </div>
        </div>
      </section>
          ...
          <div className="software-modal" role="dialog" aria-modal="true" aria-labelledby="software-modal-title" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="software-modal-header">
              ...
              <div className="software-modal-heading">
                ...
                <h2 id="software-modal-title">{selectedProduct.title}</h2>
                <div className="software-modal-category">{selectedProduct.category}</div>
              </div>
            </div>

            <div className="software-modal-content">
              <div className="software-modal-description">
                <span className="modal-section-label">SOBRE ESTA SOLUCIÓN</span>
                <p>{selectedProduct.longDescription}</p>
              </div>

              <div className="software-modal-grid">
                <div className="software-modal-block">
                  <div className="modal-block-heading"><FileKey size={17} /><span>Modalidades disponibles</span></div>

                  <div className="modalities-modal-grid">
                    {selectedProduct.modalities.map((modality) => (
                      <div className="modal-modality" key={modality}>
                        <div className="modal-check"><Check size={13} /></div>
                        <span>{modality}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="software-modal-block">
                  <div className="modal-block-heading"><ShieldCheck size={17} /><span>Características</span></div>
              ...
              <div className="software-modal-ideal">
                <div className="software-modal-ideal-icon"><Laptop size={20} /></div>
            ...
            <div className="software-modal-footer">
              ...
              <a href={createWhatsAppUrl()} target="_blank" rel="noopener noreferrer" className="software-modal-button">Solicitar información <ArrowUpRight size={17} /></a>
            </div>
          </div>
        </div>
      )}
